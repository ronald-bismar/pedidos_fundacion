...
final imageUserProfileProvider = StateNotifierProvider<ImageUserProfileNotifier, ({String name, String? urlPhoto, bool isLocal})?>
((ref) => ImageUserProfileNotifier(ref.watch(coordinatorRepoProvider)));

class ImageUserProfileNotifier extends StateNotifier<({String name, String? urlPhoto, bool isLocal})?> {
  final CoordinatorRepositoryImpl _repository;

  ImageUserProfileNotifier(this._repository) : super(null);
