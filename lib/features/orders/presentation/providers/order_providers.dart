...
final orderStatusProvider = FutureProvider.family<bool, OrderStatusArgs>((
  ref,
  args,
) async {
...
final beneficiariesByGroupProvider =
    FutureProvider.family<List<Beneficiary>, String>((ref, groupId) {
      final dataSource = ref.read(beneficiaryRemoteDataSourceProvider);
      return dataSource.getByGroup(groupId);
    });
