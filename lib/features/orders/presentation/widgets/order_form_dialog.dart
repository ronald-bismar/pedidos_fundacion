...
class _OrderFormDialogState extends State<OrderFormDialog> {
  ...
  void initState() {
    super.initState();
    _tutorController =
        TextEditingController(text: widget.orderToEdit?.tutor);
    _orderMonthController =
        TextEditingController(text: widget.orderToEdit?.orderMonth);
    _programGroupController =
        TextEditingController(text: widget.orderToEdit?.programGroup);
    ...
    _totalController =
        TextEditingController(text: widget.orderToEdit?.total.toStringAsFixed(2));
  }
