...
import 'package:pedidos_fundacion/features/encargados/presentation/providers/register_notifier.dart';
import 'package:pedidos_fundacion/features/encargados/presentation/screens/location_post_screen.dart';
import 'package:pedidos_fundacion/features/encargados/presentation/states/register_state.dart';
import 'package:pedidos_fundacion/toDataDynamic/cargos.dart';

class AuthCoordinatorScreen extends ConsumerStatefulWidget {
  const AuthCoordinatorScreen({super.key});

  @override
  ConsumerState<AuthCoordinatorScreen> createState() => _AuthScreenState();
}

class _AuthScreenState extends ConsumerState<AuthCoordinatorScreen> {
              ...
              children: [
                ...
                Column(
                  children: [
                    ...
                    subTitle(
                      'Solicite los datos al nuevo encargado',
                      textColor: dark,
                    ),
                  ],
                ),
