...
final registerDeliveryFinancialAidToBeneficiaryUseCaseProvider = Provider(
  (ref) => RegisterDeliveryFinancialAidBeneficiary(
    entregaRepository: ref.watch(deliveryRepoProvider),
  ),
);

class RegisterDeliveryFinancialAidBeneficiary {
  EntregaRepository entregaRepository;
  RegisterDeliveryFinancialAidBeneficiary({required this.entregaRepository});
  ...
  Future<Result> call(
    ...
    try {
      ...
      entregaRepository.saveFinancialAid(financialAid);
