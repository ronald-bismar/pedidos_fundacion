...
class AddBenefitsScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<AddBenefitsScreen> createState() => _AddBenefitsScreenState();
}

class _AddBenefitsScreenState extends ConsumerState<AddBenefitsScreen> {
